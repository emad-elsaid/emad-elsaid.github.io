* I didn't find a way to just include everything in my page. I wanted to include everything and let the extensions use classes. but it seems that classes are generated on the fly too.
